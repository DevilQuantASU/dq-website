...
const LeaderCard = ({ name, role, bio, image, socialLinks }) => {
    return (
        <div className="bg-gray-900 rounded-xl overflow-hidden shadow-lg border border-gray-800 transition-all hover:border-indigo-500/50 hover:shadow-indigo-500/10">
            ...
            <div className="p-6">
                ...
                <p className="text-indigo-400 text-sm font-medium mb-4">{role}</p>
                ...
                <div className="flex space-x-4">
                    ...
                    {socialLinks?.portfolio && (
                        <a href={socialLinks.portfolio} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
