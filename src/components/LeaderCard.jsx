        ...
        <div className="bg-neutral-900 overflow-hidden border border-neutral-800 transition-all hover:border-neutral-600">
            <div className="aspect-w-1 aspect-h-1 w-full bg-neutral-800 relative">
                {image ? (
                    ...
                    <div className="w-full h-64 flex items-center justify-center bg-neutral-800 text-neutral-600">
            ...
            <div className="p-6">
                ...
                <p className="text-neutral-400 text-sm font-medium mb-4">{role}</p>
                ...
                <div className="flex space-x-4">
                    ...
                    {socialLinks?.portfolio && (
                        <a href={socialLinks.portfolio} target="_blank" rel="noopener noreferrer" className="text-neutral-400 hover:text-white transition-colors">
